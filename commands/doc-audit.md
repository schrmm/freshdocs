...
4. If any section is large (e.g., dozens of wildcard-only or uncovered files), summarize and offer to dive into a specific category rather than dumping everything.
